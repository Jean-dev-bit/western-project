...
//         <input type="text" placeholder="Clients" required />
//         <input type="text" placeholder="Nom de Banque" required />
...
//         </select>
//         <input type="number" placeholder="Quantité achetée" required />
...
const AddProductPage = () => {
  ...
  const handleSelectClient = (client) => {
    ...
    setSearchTerm(`${client.nom} ${client.prenoms}`); // Met le nom et prénom dans le champ de recherche
    setClients([]); // Vide les suggestions après sélection
  };
